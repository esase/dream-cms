...
(61, 'file_manager_allowed_extensions', 'Allowed file extensions', 'You should separate values by a comma', 'textarea', 1, 1, 12, 4, NULL, NULL, '$values = explode(",", "__value__");\r\n\r\nforeach($values as $value)\r\n{\r\n    if (preg_match("/ph(p[3-7]?|tml)$/", $value)) {\r\n        return false;\r\n    }\r\n}\r\n\r\nreturn true;', 'You cannot use PHP scripts'),
...
INSERT INTO `page_widget_setting` (`id`, `name`, `widget`, `label`, `type`, `required`, `order`, `category`, `description`, `check`, `check_message`) VALUES
(1,  'page_html_content', 1, 'Html content', 'htmlarea', NULL, 2, 1, NULL, NULL, NULL),
(2,  'page_contact_form_email', 15, 'Email', 'email', 1, 1, 1, 'Email address which uses for receiving messages from the contact form', NULL, NULL),
(3,  'page_contact_form_title', 15, 'Message title', 'notification_title', 1, 1, 1, 'Contact form notification', NULL, NULL),
(4,  'page_contact_form_message', 15, 'Message', 'notification_message', 1, 1, 1, NULL, NULL, NULL),
(5,  'page_contact_form_captcha', 15, 'Show captcha', 'checkbox', NULL, 2, 1, NULL, NULL, NULL),
(6,  'page_sidebar_menu_type', 16, 'Type of the sidebar menu', 'select', 1, 1, 1, NULL, NULL, NULL),
(7,  'page_sidebar_menu_show_dynamic', 16, 'Show dynamic pages', 'checkbox', NULL, 2, 1, NULL, NULL, NULL),
(8,  'page_share_buttons_visible_list', 17, 'Visible share buttons list', 'multiselect', 1, 1, 1, NULL, NULL, NULL),
(9,  'page_share_buttons_show_extra', 17, 'Show extra share buttons', 'checkbox', NULL, 2, 1, NULL, NULL, NULL),
