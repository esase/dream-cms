...
class UserController extends AbstractBaseController
{
    ...
    public function activateAction()
    {
        ...
        $activateForm = $this->getServiceLocator()
            ...
            ->getInstance('Users\Form\ActivationCode')
        ...
        if ($request->isPost()) {
            ...
            if ($resetForm->getForm()->isValid()) {
                ...
                if (is_array($resetedPassword)) {
                    ...
                    // fire the event
                    UsersEvent::fireEvent(UsersEvent::USER_PASSWORD_RESET,
            ...
            if ($userForm->getForm()->isValid()) {
                ...
                if (true == ($result = $this->getModel()->editUser((array) UsersService::getCurrentUserIdentity(),
                    ...
                    UsersEvent::fireEvent(UsersEvent::USER_EDIT, UsersService::getCurrentUserIdentity()->user_id,
                            UsersService::getCurrentUserIdentity()->user_id,
                            'Event - User edited', array(UsersService::getCurrentUserIdentity()->nick_name,
                            UsersService::getCurrentUserIdentity()->user_id));
        ...
        if ($request->isPost()) {
            ...
            if ($forgotForm->getForm()->isValid()) {
                ...
                if (is_array($activationCode)) {
                    ...
                    // fire the event
                    UsersEvent::fireEvent(UsersEvent::USER_PASSWORD_RESET_REQUEST,
                ...
                if (is_numeric($result)) {
                    ...
                    if ((int) $this->getSetting('user_registered_send')) {
                        EmailNotification::sendNotification($this->getSetting('application_site_email'),
                            $this->getSetting('user_registered_title', UsersService::getDefaultLocalization()['language']),
                            $this->getSetting('user_registered_message', UsersService::getDefaultLocalization()['language']), array(
                                'find' => array(
                                    'RealName',
                                    'Email'
                                ),
