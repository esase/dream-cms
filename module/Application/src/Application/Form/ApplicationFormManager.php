...
class ApplicationFormManager
{
    ...
    public function getInstance($formName)
    {
        ...
        if (!$form instanceof ApplicationCustomFormInterface) {
            throw new InvalidArgumentException(sprintf($formName . ' must be an object implementing ApplicationCustomFormInterface'));
        }
