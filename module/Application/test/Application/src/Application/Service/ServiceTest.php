...
class ServiceTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testBaseSettings()
    {
        ...
        foreach ($this->settingsNames as $setting) {
            $this->assertEquals(ApplicationService::getSetting($setting), $baseValue);
        }
    }
    ...
    public function testSettingsByLanguage()
    {
        ...
        // check settings
        foreach ($this->settingsNames as $setting) {
            $this->assertEquals(ApplicationService::getSetting($setting), $currentLocalization['locale']);
        }
    }
    ...
    public function testNotExistSettings()
    {
        ...
        // check setting
        foreach ($this->settingsNames as $setting) {
            $this->assertFalse(ApplicationService::getSetting($setting));
        }
    }
}
