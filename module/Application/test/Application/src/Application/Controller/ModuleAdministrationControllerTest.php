...
use Application\Controller\ModuleAdministrationController;
...
class ModuleAdministrationControllerTest extends PHPUnit_Framework_TestCase
{
    /**
     * Index controller
     * @var object
    ...
    protected function setUp()
    {
        ...
        $this->controller = new ModuleAdministrationController();
